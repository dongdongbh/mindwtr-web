...
- Builds configured with heartbeat analytics may send a small app-health event; it does not include task, project, note, file, AI prompt, or account content. See `https://github.com/dongdongbh/Mindwtr/blob/main/docs/PRIVACY.md`.
