...
| Ziel | Wann es verwendet wird |
| ----------------- | ----------------------------------- |
| **Nächste Aktionen** | Umsetzbare Aufgaben, die Sie selbst erledigen |
| **Projekte** | Ergebnisse, die mehrere Aktionen erfordern |
| **Warten** | An eine andere Person delegiert |
| **Kalender** | Muss zu einem bestimmten Zeitpunkt stattfinden |
| **Irgendwann/Vielleicht** | Ideen für die Zukunft |
| **Referenz** | Aufzubewahrende Informationen (Notizen) |
| **Papierkorb** | Nicht benötigt |
...
✓ Gut: „Projektordner öffnen und Statusnotizen prüfen“
...
Siehe auch: [Kontexte und Tags](/de/use/contexts-tags)
...
- [GTD in 15 Minutes](https://hamberg.no/gtd): Kurze Einführung
- [Getting Things Done (Buch)](https://gettingthingsdone.com/) — David Allens Originalbuch
- [r/gtd](https://reddit.com/r/gtd): GTD-Community auf Reddit
