...
全新安裝時，Mindwtr 會詢問你要全新開始、匯入備份，或連接同步。選擇**全新開始**會以你的語言建立**快速上手**專案並立即開啟，讓你直接在應用程式中熟悉工作流程。之後啟動時，Mindwtr 預設開啟**專注**檢視，讓今日行事曆項目與下一步行動優先呈現。需要迅速記下一個想法時，隨時將新工作收進**收集箱**。
