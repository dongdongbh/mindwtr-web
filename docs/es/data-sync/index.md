...
[Abrir el diagrama interactivo](/assets/diagrams/sync-setup.html)
...
- **Cambia la tarea programada** en **Ajustes → Sincronización → Sincronización en segundo plano**: Desactivada, cada 15 minutos (el valor predeterminado y el mínimo de la plataforma), cada hora o cada 6 horas. Se aplica a WebDAV, la nube autoalojada, Dropbox e iCloud, se configura por dispositivo y no cambia la sincronización con la aplicación abierta. Con la opción desactivada, los cambios de otros dispositivos llegan la próxima vez que abres la aplicación.
