...
- **Appui long pour une date de début** : faites un appui long sur une tâche sans échéance pour définir sa date de début : **Aujourd’hui**, **Demain**, **Semaine prochaine** ou une date personnalisée. **Aujourd’hui** place la tâche sous Aujourd’hui sans la marquer comme focus du jour. Une date ultérieure la retire des listes d’actions jusqu’à ce jour.
