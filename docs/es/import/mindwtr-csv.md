...
- A partir de la próxima versión, la exportación filtrada de escritorio estará en **Más (⋯) → Exportar los resultados actuales como CSV**, junto al nombre de la aplicación en la barra lateral. Está disponible en listas de tareas, Contextos, búsquedas guardadas, un proyecto, Enfoque, Tablero y Revisión. Exporta los resultados tras los filtros, la búsqueda y la selección de área, incluidos los grupos plegados y las filas fuera de la pantalla visible. La acción se desactiva si no hay resultados o la vista no admite la exportación filtrada. La exportación completa sigue en Ajustes.
