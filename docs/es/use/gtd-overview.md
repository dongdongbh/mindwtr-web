...
❌ Mal: «Trabajar en el proyecto»
✓ Bien: «Abrir la carpeta del proyecto y revisar las notas de estado»
...
Consulta también: [Contextos y etiquetas](/es/use/contexts-tags).
...
- [GTD in 15 Minutes](https://hamberg.no/gtd): introducción rápida.
- [Getting Things Done (libro)](https://gettingthingsdone.com/): el libro original de David Allen.
- [r/gtd](https://reddit.com/r/gtd): comunidad GTD en Reddit.
