...
3. Busca **Mindwtr** y añade el widget **Tareas** o el botón de una celda **Captura rápida**. El widget Tareas muestra un botón **+** y tus tareas, cada una con su color de prioridad, su proyecto o área y su fecha de vencimiento. En Android, un widget Tareas recién añadido muestra Foco, con el recuento de la bandeja de entrada en su encabezado y las mismas secciones que la pantalla Foco: Foco de hoy, Hoy, Revisión pendiente, Próximas acciones, Próximas, en el orden predeterminado de Foco y sin filtros. Para cambiar de lista, toca el título del widget, que lleva una pequeña flecha hacia abajo. Se abre una lista con Foco, Bandeja de entrada, Próximas acciones, En espera, Algún día/Tal vez y tus proyectos, cuyas secciones se convierten en encabezados. Toca uno y el widget se vuelve a dibujar. Esto funciona en cualquier lanzador, y algunos lanzadores no ofrecen ninguna acción de edición propia para los widgets. Puedes añadir varios widgets Tareas con listas distintas.
4. Toca una tarea para abrirla, toca el anillo al principio de una fila para completarla o toca **+** para capturar

En Android, tocar el anillo completa la tarea. La fila aparece tachada de inmediato y un segundo toque en unos tres segundos lo deshace. La tarea sigue tachada en el widget hasta que Mindwtr se ejecute la próxima vez y la complete allí; desde la aplicación también se sincroniza con tus otros dispositivos.
