...
[Ouvrir le diagramme interactif](/assets/diagrams/sync-setup.html)
...
- **Modifiez la tâche planifiée** dans **Réglages → Synchronisation → Synchronisation en arrière-plan** : Désactivée, toutes les 15 minutes (valeur par défaut et minimum de la plateforme), toutes les heures ou toutes les 6 heures. Ce réglage s’applique à WebDAV, au cloud auto-hébergé, à Dropbox et à iCloud, se définit par appareil et ne change rien à la synchronisation lorsque l’application est ouverte. Lorsqu’il est désactivé, les modifications des autres appareils arrivent à la prochaine ouverture de l’application.
