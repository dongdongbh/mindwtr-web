...
Mindwtr is built to be **simple by default, powerful when you need it, and forgiving when life gets messy**. We focus on reducing cognitive load, cutting the fat, and keeping users in flow. Every contribution is weighed against these tenets:
...
- **Forgiving when life gets messy.** Never shame the user for capacity they did not have: coming back after time away must be easy, big backlogs get bounded sessions, stale items invite reconsideration, and there are no streaks or productivity scores.
...
See [Mobile Installation](/start/mobile-installation) for detailed build instructions.

---

## Architecture Overview

See [Architecture](/developers/architecture) for detailed technical design.
