...
- A project with a start date or a due date gets its own slim bar above its tasks, even before any of those tasks have dates of their own; when only one of the two is set, the bar reaches to the earliest start or latest due date among those tasks
