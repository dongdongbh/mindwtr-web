...
1. 安装 F-Droid 客户端。
2. 打开 [F-Droid 上的如水](https://f-droid.org/en/packages/tech.dongdongbh.mindwtr/)并安装。
...
2. 打开 [IzzyOnDroid 上的如水](https://apt.izzysoft.de/fdroid/index/apk/tech.dongdongbh.mindwtr)并安装。
...
为了确保如水能够持续存在和发展，非常感谢你的支持。如果这款应用对你有价值，请考虑通过 [GitHub Sponsors](https://github.com/sponsors/dongdongbh) 或 [Ko-fi](https://ko-fi.com/D1D01T20WK) 支持项目。
