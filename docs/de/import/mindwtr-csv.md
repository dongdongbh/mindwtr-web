...
- Ab der nächsten Version finden Sie den gefilterten Desktop-Export unter **Mehr (⋯) → Aktuelle Ergebnisse als CSV exportieren**, neben dem App-Namen in der Seitenleiste. Er steht in Aufgabenlisten, Kontexten, gespeicherten Suchen, einem Projekt, Fokus, Board und Rückblick bereit. Exportiert werden die Ergebnisse nach Filtern, Suche und Bereichsauswahl, einschließlich eingeklappter Gruppen und Zeilen außerhalb des sichtbaren Ausschnitts. Ohne Ergebnisse oder in nicht unterstützten Ansichten ist die Aktion deaktiviert. Der vollständige Export bleibt in den Einstellungen.
