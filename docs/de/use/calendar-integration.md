...
- Ist für eine wiederkehrende Aufgabe **Künftige Wiederholungen im Kalender anzeigen** aktiviert, zeigt der Kalender reine Planungsvorschauen aller Vorkommen im sichtbaren Bereich. Diese Vorschauen sind keine echten Aufgaben. Bei der Übertragung in mobile oder macOS-Kalender wird weiterhin nur das nächste Vorkommen als normaler einzelner Termin geschrieben, nicht als nativer Serientermin.
