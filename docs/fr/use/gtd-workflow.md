...
- La **date de début** est un seuil de report/disponibilité. Par défaut, une date de début future masque la tâche dans Focus. Lorsque cette date arrive, la tâche réapparaît avec le statut qu’elle avait déjà. Si le début comporte une heure précise, Focus et les prochaines actions gardent la tâche masquée jusqu’à cette heure : une tâche démarrable à 17 h n’encombre pas la liste du matin. Les débuts prévus dans les 7 prochains jours, y compris plus tard le même jour, restent visibles en aperçu dans la section **À venir** de Focus, si bien qu’un report n’arrive jamais sans prévenir.
...
4. **À venir** donne un aperçu des tâches `next` que le report retient actuellement mais qui apparaîtront dans les 7 prochains jours : une date de début future, ou une tâche récurrente qui attend sa prochaine date d’échéance ou de revue. Une tâche dont l’heure de début tombe plus tard le même jour y figure aussi, puisque Focus la masque jusqu’à cette heure. Les lignes sont triées par le jour où elles apparaîtront et affichent cette date. Une ligne qui démarre plus tard aujourd’hui peut être étoilée dans le Focus du jour — l’étoile est conservée et la tâche y réapparaît à son heure de début — contrairement à une ligne reportée à un autre jour. La section disparaît lorsque rien n’arrive.
