...
| ----------------- | ----------------------------------- |
| **Prochaines actions** | Tâches réalisables que vous effectuerez vous-même |
| **Projets** | Résultats nécessitant plusieurs actions |
| **En attente** | Éléments délégués à quelqu’un d’autre |
| **Calendrier** | Ce qui doit arriver à un moment précis |
| **Un jour/Peut-être** | Idées pour l’avenir |
| **Référence** | Informations à conserver (notes) |
| **Corbeille** | Ce qui n’est pas utile |
...
✓ Bon : « Ouvrir le dossier du projet et examiner les notes d’avancement »
...
Voir aussi : [Contextes et tags](/fr/use/contexts-tags)
...
- [GTD in 15 Minutes](https://hamberg.no/gtd) : introduction rapide
- [Getting Things Done (livre)](https://gettingthingsdone.com/) — livre original de David Allen
- [r/gtd](https://reddit.com/r/gtd) : communauté GTD sur Reddit
