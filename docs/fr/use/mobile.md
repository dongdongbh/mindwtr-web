...
- **Appui long pour une date de début** : faites un appui long sur une tâche pour définir sa date de début : **Aujourd’hui**, **Demain**, **Semaine prochaine** ou une date personnalisée. **Aujourd’hui** place la tâche sous Aujourd’hui sans la marquer comme focus du jour. Une date ultérieure la retire des listes d’actions jusqu’à ce jour. Une tâche avec une échéance ne propose que des dates de début jusqu’à cette échéance, et une tâche due aujourd’hui ou en retard n’a pas de menu.
...
Dans les listes de tâches, l’icône de récurrence reste visible lorsque les détails sont masqués ; la description complète du calendrier de récurrence apparaît dans les détails de la tâche.
