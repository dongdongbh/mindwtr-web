...
El widget Tareas muestra primero Foco de hoy y después Hoy, incluidas las tareas vencidas. No llena el espacio vacío con otras próximas acciones. En Android, sigue los filtros y el orden de la pantalla Foco. Los filtros que has puesto allí también se aplican al widget: contextos, etiquetas, prioridad, energía, tiempo estimado y un filtro guardado. El orden que has elegido en la pantalla Foco se aplica igualmente, y el widget se actualiza cuando cambias cualquiera de los dos. El área que tienes seleccionada en la aplicación acota todas las listas del widget.
...
- **Pulsación larga para una fecha de inicio**: mantén pulsada una tarea para fijar su fecha de inicio: **Hoy**, **Mañana**, **Próxima semana** o una fecha personalizada. **Hoy** coloca la tarea en Hoy sin marcarla como foco del día. Una fecha posterior la saca de las listas de acciones hasta ese día. A una tarea con fecha de vencimiento solo se le ofrecen fechas de inicio hasta ese día, y una tarea que vence hoy o está vencida no tiene menú.
...
Las tareas con hora de vencimiento pueden configurar **Repetir recordatorio** cada 5, 10, 15, 30 o 60 minutos después del primer aviso de vencimiento. **Omitir recordatorios** desactiva los avisos de inicio y vencimiento de esa tarea. **Repetir recordatorio: Desactivado** no desactiva el primer aviso.
...
2. Comprueba **Omitir recordatorios**: **Desactivado** permite los avisos de esta tarea; **Activado** los omite. En versiones anteriores, el borde azul de esta opción significa **Activado**.
3. Toca **Guardar**. En **Ajustes → Notificaciones**, activa las notificaciones de tareas y los avisos de vencimiento. En iOS, permite también las notificaciones de Mindwtr en los ajustes del dispositivo.
4. Espera a la hora de vencimiento. Si cambiaste la tarea en otro dispositivo, abre Mindwtr en este teléfono para sincronizar la nueva hora antes del aviso.
...
- **Importación de Recordatorios de Apple**: elige una lista de Recordatorios e importa los recordatorios incompletos a la Bandeja de entrada. Los recordatorios importados permanecen en Recordatorios de Apple salvo que actives **Eliminar los recordatorios importados**; se omiten los ya importados, completados o sin título. El interruptor **Importar automáticamente** ejecuta la importación cada vez que se abre Mindwtr.
- **Opciones de sincronización de ajustes**: elige qué preferencias se sincronizan entre dispositivos (tema, idioma/formato de fecha, valores GTD predeterminados, URL de calendarios externos, ajustes de IA y Filtros guardados). Las claves de API, las URL de endpoints de IA personalizados (incluido el endpoint de voz a texto), los parámetros de petición adicionales y las rutas de modelos locales nunca se sincronizan. Un endpoint personalizado se escribe una vez en cada dispositivo.
