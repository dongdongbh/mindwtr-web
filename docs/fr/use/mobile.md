...
3. Trouvez **Mindwtr** et ajoutez soit le widget **Tâches**, soit le bouton d’une cellule **Capture rapide**. Le widget Tâches affiche un bouton **+** et vos tâches, chacune avec sa couleur de priorité, son projet ou domaine et sa date d’échéance. Sous Android, un widget Tâches qui vient d’être ajouté affiche Focus, avec le nombre d’éléments de la boîte de réception dans son en-tête et les mêmes sections que l’écran Focus : Focus du jour, Aujourd’hui, Revue due, Prochaines actions, À venir, dans l’ordre Focus par défaut et sans filtre. Pour changer de liste, touchez le titre du widget, qui porte une petite flèche vers le bas. Une liste s’ouvre avec Focus, Boîte de réception, Prochaines actions, En attente, Un jour/Peut-être et vos projets, dont les sections deviennent des en-têtes. Touchez-en un et le widget se redessine. Cela fonctionne sur tous les lanceurs, et certains lanceurs ne proposent aucune action de modification pour les widgets. Vous pouvez ajouter plusieurs widgets Tâches avec des listes différentes.
4. Touchez une tâche pour l’ouvrir, touchez l’anneau au début d’une ligne pour la terminer, ou touchez **+** pour capturer

Sous Android, toucher l’anneau termine la tâche. La ligne est barrée aussitôt, et un second appui dans les trois secondes annule l’action. La tâche reste barrée sur le widget jusqu’au prochain lancement de Mindwtr, qui la termine alors ; c’est aussi depuis l’application qu’elle est synchronisée avec vos autres appareils.
