...
4. **Próximas** previsualiza las tareas `next` que el aplazamiento retiene ahora mismo pero que aparecerán dentro de los próximos 7 días: una fecha de inicio futura, o una tarea recurrente que espera su siguiente fecha de vencimiento o revisión. También aparece aquí una tarea cuya hora de inicio es más tarde el mismo día, que Enfoque oculta hasta esa hora. Las filas se ordenan por el día en que aparecerán y muestran esa fecha. Una fila que empieza más tarde hoy sí se puede marcar con estrella para el Foco de hoy —la estrella se mantiene y la tarea reaparece allí a su hora de inicio—, mientras que una aplazada a otro día no. La sección desaparece cuando no viene nada.
