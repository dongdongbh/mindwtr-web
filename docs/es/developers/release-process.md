...
La beta de Flathub requiere la rama beta y permisos en `flathub/tech.dongdongbh.mindwtr`. La publicación en AUR usa un flujo manual independiente protegido por el Environment `aur-publish` de GitHub. Revisa la propuesta guardada, aprueba el despliegue del Environment y publica solo cuando AUR acepte envíos. El mantenimiento de AUR retrasa ese canal sin hacer fallar el lanzamiento de Mindwtr.
